...
export default function LibraryFilters({
  ...
  return (
    <div className="space-y-2">
      ...
      {/* Loading Indicator Feedback Bar when filtering is pending */}
      {isPending && (
        <div className="flex items-center justify-center gap-2 text-xs font-semibold text-accent bg-accent-muted/40 py-1.5 px-3 rounded-lg border border-accent/20 animate-pulse">
          ...
          <span>Memperbarui tontonan...</span>
        </div>
      )}
    </div>
  )
